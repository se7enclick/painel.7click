...
class Contracts extends Security_Controller
{
    ...
    function list_data()
    {
        ...
        $options = array(
            ...
            "contracts_label" => $this->request->getPost("contracts_label"),
    ...
    private function _make_row($data, $custom_fields)
    {
        ...
        $contracts_label = make_labels_view_data($data->labels_list, false);
        ...
        $contract_url = "";
        if ($this->login_user->user_type == "staff") {
            $contract_url = anchor(get_uri("contracts/view/" . $data->id), $contracts_label);
        } else {
            //for client
            $contract_url = anchor(get_uri("contracts/preview/" . $data->id), $contracts_label);
        }

...
if (!function_exists('prepare_contract_view')) {
    ...
    function prepare_contract_view($contract_data)
    {
        if ($contract_data) {
            ...
            $parser_data["CONTRACT_ITEMS_DESCRIPTION"] = view("contracts/contract_parts/contract_items_description", $contract_data);
            $parser_data["CONTRACT_ITEMS_CONTENT"] = view("contracts/contract_parts/contract_items_content", $contract_data);
            $parser_data["CONTRACT_ITEMS_DELIVERY_OF_SERVICE"] = view("contracts/contract_parts/contract_items_delivery_of_service", $contract_data);
            ...
            if ($contract_info->status === "accepted" && ($signer_info || $contract_info->accepted_by)) {
                ...
                $parser_data["CLIENT_SIGNER_RG"] = $contract_info->accepted_by ? $contract_info->signer_rg : get_array_value($signer_info, "rg");
                $parser_data["CLIENT_SIGNER_CPF"] = $contract_info->accepted_by ? $contract_info->signer_cnpj : get_array_value($signer_info, "cnpj");
                ...
                $staff_signer_info = $Users_model->get_one_where(['client_id' => $contract_info->client_id]);

                $parser_data["CLIENT_SIGNER_NAME"] = $staff_signer_info->first_name . " " . $staff_signer_info->last_name;
                $parser_data["CLIENT_SIGNER_RG"] = $staff_signer_info->rg;
                $parser_data["CLIENT_SIGNER_CPF"] = $staff_signer_info->cpf;
                $parser_data["CLIENT_SIGNER_EMAIL"] = $staff_signer_info->email;
                $parser_data["CLIENT_SIGNING_DATE"] = "";
                $parser_data["CLIENT_SIGNATURE"] = "";
            }
            ...
            if ($contract_info->staff_signed_by) {
                ...
                $parser_data["STAFF_SIGNER_RG"] = $staff_signer_info->rg;
                $parser_data["STAFF_SIGNER_CPF"] = $staff_signer_info->cpf;
                ...
                $parser_data["STAFF_SIGNER_NAME"] = "____________________";
                $parser_data["STAFF_SIGNER_RG"] = "__.___-__";
                $parser_data["STAFF_SIGNER_CPF"] = "___.___.___-__";
                $parser_data["STAFF_SIGNER_EMAIL"] = "____________@_____________._____";
                $parser_data["STAFF_SIGNING_DATE"] = "__/__/____";
                $parser_data["STAFF_SIGNATURE"] = "____________________";
            }
            ...
            $parser_data["COMPANY_CNPJ"] = $company_info->cnpj;
...
if (!function_exists('get_available_contract_variables')) {
    ...
    function get_available_contract_variables()
    {
        $variables = array(
            ...
            "CONTRACT_ITEMS_CONTENT",
            "CONTRACT_ITEMS_DELIVERY_OF_SERVICE",
            "CONTRACT_NOTE",
            "APP_TITLE",
            "PROJECT_TITLE",
            /* signature info */

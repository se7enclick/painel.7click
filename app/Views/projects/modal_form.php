...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="contract_id" class=" col-md-3"><?php echo app_lang('contract'); ?></label>
                <div class="col-md-9" id="contract-dropdown-section">
                    <?php
                    echo form_input(array(
                        "id" => "contract_id",
                        "name" => "contract_id",
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#client_id").on("change", function () {
            ...
            if ($(this).val()) {
                $('#contract_id').select2("destroy");
                $("#contract_id").hide();
                appLoader.show({container: "#contract-dropdown-section"});
                $.ajax({
                    url: "<?php echo get_uri("contract/get_project_suggestion") ?>" + "/" + client_id,
                    dataType: "json",
                    success: function (result) {
                        $("#contract_id").show().val("");
                        $('#contract_id').select2({data: result});
                        appLoader.hide();
                    }
                });
            }

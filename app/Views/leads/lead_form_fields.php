...
<div class="form-group">
    <div class="row">
        <label for="cnpj" class="<?php echo $label_column; ?>"><?php echo app_lang('cnpj'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "cnpj",
...
$("#zip").blur(function() {
    ...
    var validazip = /^[0-9]{8}$/;
        ...
        if(validazip.test(zip)) {
            ...
            $.getJSON("//viacep.com.br/ws/"+ zip +"/json/?callback=?", function(dados) {
            
            if (!("erro" in dados)) {
                $("#address").val(dados.logradouro + ", nº ");
                $("#address").focus();
    ...
    $("#zip").mask("00000-000", { placeholder: "00000-000" });
    $('#phone').mask("(00) 0000-0000", { placeholder: "(48) 0000-0000" });
    $("#rg").mask('00.000.000-0', {reverse: true});
    $('#cpf').mask('000.000.000-00', {reverse: true});
    $('#cnpj').mask('00.000.000/0000-00', {reverse: true});
    $('#website').mask('https://www.ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ', {
        translation: {
        'Z': {
            pattern: /[0-9]|[a-z]|[.]/, optional: true
        }
        }
    });
    });

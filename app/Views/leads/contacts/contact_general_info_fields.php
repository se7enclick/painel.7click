...
<div class="form-group">
    <div class="row">
        <label for="rg" class="<?php echo $label_column; ?>"><?php echo app_lang('rg'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "rg",
...
<div class="form-group">
    <div class="row">
        <label for="cpf" class="<?php echo $label_column; ?>"><?php echo app_lang('cpf'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "cpf",
                "name" => "cpf",
                "value" => $model_info->cpf,
                "class" => "form-control",
                "placeholder" => app_lang('cpf'),
                "data-rule-required" => true,
                "data-msg-required" => app_lang("field_required"),
            ));
            ?>
...
<div class="form-group">
    <div class="row">
        ...
        <div class="<?php echo $field_column; ?>">
            ...
            echo form_dropdown(
                    "job_title", array(
                        "master" => app_lang("master"),
                        "employe" => app_lang("employe")
                    ), $model_info->job_title, "class='select2 form-control mini' id='job_title'"
            );
            ?>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#phone').mask("(00) 00000-0000", { placeholder: "(48) 0000-0000" });

...
class Payment_methods_model extends Crud_model {
    ...
    function get_settings($type = "") {
        $settings = array(
            ...
            "gerencianet" => array(
                array("name" => "pay_button_text", "text" => app_lang("pay_button_text"), "type" => "text", "default" => "Gerencianet"),
                array("name" => "sandbox", "text" => app_lang("testing_environment"), "type" => "boolean", "default" => "0"),
                array("name" => "clientId", "text" => "Client ID", "type" => "text", "default" => ""),
                array("name" => "clientSecret", "text" => "Client Secret", "type" => "text", "default" => ""),
            ),
